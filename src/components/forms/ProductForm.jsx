            ...
            <div className='row'>
				...
				<div className='col-12'>
                    <div className='form-group'>
                        ...
                        placeholder={_('slug')} value={props.useProduct.slug ?? ''}
                        disabled={props.isDisabled} onChange={ e => 
				...
				<div className='col-12'>
                    <div className='form-group'>
                        <label htmlFor='images_url_list'>{_('images_url_list')}</label>
                        <input className='form-control' type='text' id='images_url_list' name='images_url_list' 
                        placeholder={_('images_url_list')} value={props.useProduct.images_url_list ?? ''}
                        disabled={props.isDisabled} onChange={ e => 
